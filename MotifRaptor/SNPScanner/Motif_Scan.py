...
def index_func(command_address, outputdirname, seqfilename):
    ...
    mksary_command_1=command_address+" "+seq_filename+" "+sa_filename
    mksary_command_2=command_address+" "+seq_filename+" "+lcp_filename
    status_1=os.system(mksary_command_1) #./mksary $seq_file $sa_file
    status_2=os.system(mksary_command_2) #./mksary $seq_file $lcp_file
...
def main():
    ...
    if args.command=="index":
        ...
        mksary_path=os.path.dirname(os.path.abspath(__file__))
        run_mksary(mksary_path, args.genome_db, args.genome_db, args.thread_num)
